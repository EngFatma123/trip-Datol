...
function defineComponent(options, extraOptions) {
  return isFunction2(options) ? (() => extend2({ name: options.name }, extraOptions, { setup: options }))() : options;
}
      ...
      if (props) {
        if (true) {
          ...
          for (const key in props) {
            ...
            if (forcePatch && (key.endsWith("value") || key === "indeterminate") || isOn(key) && !isReservedProp2(key) || key[0] === "." || isCustomElement) {
...
var isOn2 = (key) => key.charCodeAt(0) === 111 && key.charCodeAt(1) === 110 && (key.charCodeAt(2) > 122 || key.charCodeAt(2) < 97);
...
* @license MIT
**/
//# sourceMappingURL=chunk-B345V3BC.js.map
